...
public class Start {
	...
	private static String languageFilename = "Language.lng";
	...
	/**
	 * Load language (English or Romana)
	 * @return the language
	 */
	private static String loadLanguage() {
		String fileSeparator = System.getProperty("file.separator");
		String curentDir = System.getProperty("user.dir");
		String filename1 = curentDir + fileSeparator + languageFilename;
	...
	public static void main(String[] args) {
		...
		if (loadLanguage().equals("Romana"))
			PatientRx.lang=".RO";
		else if (loadLanguage().equals("English"))
			PatientRx.lang="";
		else if (loadLanguage().equals(""))
			PatientRx.lang="";
		new PatientRx();
